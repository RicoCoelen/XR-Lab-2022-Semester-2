   ...
   public void UpdateMenus()
   {
        ...
        if(rightMenuButton)
        {
            if (!runonceRight)
            {
                ...
                palette.transform.position = playerHead.transform.position + (playerHead.transform.forward * 1f);
                palette.transform.position = playerHead.transform.position + (-playerHead.transform.up * 0.1f);
